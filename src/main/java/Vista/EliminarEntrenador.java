 ...
 * @author USUARIO
 */
public class EliminarEntrenador extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Puede Elegir el Deportista de la Lista de Registros");

        jLabel3.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(153, 153, 153));
        jLabel3.setText("Ingresar el Numero de Cedula del Entrenador que Desea Eliminar");

        jLabel4.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(153, 153, 153));
        jLabel4.setText("Elegir la Disciplina Deportiva que Desea Buscar");
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        ConsultasEntrenador consultasEntrenador = new ConsultasEntrenador();

        Personas entrenador = new Personas();
        entrenador.setCedula(cedula);

        boolean eliminado = consultasEntrenador.eliminar(entrenador);

        if (eliminado) {
            JOptionPane.showMessageDialog(this, "Deportista Entrenador correctamente.", "Éxito", JOptionPane.INFORMATION_MESSAGE);
            txtCedula.setText("");
        } else {
